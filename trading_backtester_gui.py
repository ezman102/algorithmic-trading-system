...
class TradingSystemBacktester:
    ...
    def setup_ui(self):
        ...
        self.indicator_selections = self.create_checkboxes(available_indicators, 3)
        ...
        find_best_button.grid(row=9, column=0, columnspan=2, sticky='we')

        visualize_button = tk.Button(self.root, text="Visualize Decision Trees", command=self.visualize_trees)
        visualize_button.grid(row=10, column=0, columnspan=2, sticky='we')
