...
def main():
    ...
    if mode == 'classification':
                ...
                for combination in all_combinations:
                    ...
                    cv_strategy = dynamic_cv_strategy(target=y_train_subset, classification=True, n_splits=5)
                    ...
                    accuracy = best_model.score(X_test_subset, y_test_subset)
                    next_day_prediction = best_model.predict(features_subset_imputed[-1].reshape(1, -1))[0]
